...
There are a few issues; iChat doesn't always seem to want to start a screen-sharing session, more often if James tries to connect to my screen than the other way round. This may be something to do with my local network setup. The other problem is if you need to move your mouse to your own screen (or to switch screens), the cursor will still move on the remote screen until you've moved to the other screen, which can cause some confusion.
...
* *Bonus Tip*: Quicksilver can be useful for leaving the equivalent of little notes to eachother whilst the other person is away; if you're pair has gone to make a tea/popped to the toilet and you need to leave too, just leave them a nice big message on their screen - bring up Quicksilver, hit Cmd+. to enter text mode, write your message then hit tab and select "Large Type". They can't miss it.
 

If you've never paired before, or have been put off of pairing because you work remotely, give it a try; you may find you write better code than you ever did before.